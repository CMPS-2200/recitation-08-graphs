...
In this lab, we'll learn more about graphs and how to navigate them. 

To complete this recitation, follow the instructions in [recitation-08.md](recitation-08.md) ([PDF version](recitation-08.pdf)). Below you'll find important and useful information about submitting your work, using git, and testing your code. 
